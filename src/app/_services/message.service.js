...
var MessageService = (function () {
    ...
    MessageService.prototype.getMyMessages = function (_id) {
        return this.http.get(this.config.apiUrl + '/messages/my-messages/' + _id, this.jwt()).map(function (response) { return response.json(); });
    };
